...
<html>
    ...
    <body>
        <%
            // Fetch the ticket object from the request attribute
        ...
        <table>
            ...
            <tr><th>Priority</th>
                <td><%= ticket.getPriority() != null ? ticket.getPriority().getPriorityLevel(): "Not Assigned"%></td>
            </tr>
            <tr><th>Assigned To</th>
                <td><%= (ticket.getAssignedTo() == null || ticket.getAssignedTo().getUserId() <= 0) ? "Not Assigned" : ticket.getAssignedTo().getFullName()%></td>
            </tr>
        </table>
        ...
        <form action="TicketManagementServlet" method="POST">
            ...
            <select name="assignedTo" id="assignedTo">
                ...
                %>
                <option value="<%= technician.getUserId()%>" <%= ticket.getAssignedTo().getUserId() == technician.getUserId() ? "selected" : ""%> >
